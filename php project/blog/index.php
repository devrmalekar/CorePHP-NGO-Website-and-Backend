<?php
    ...
    $allBlogs = $dbFunction->Select("SP_ListBlog", null, null);
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
<head>
    <title>parent organization Nepal | Blogs</title>
...
<div class="white"><div class="center">
        ...
        <div class="row">
            <div class="heading"><p class="text6">Our Blog</p></div>
            <nav>
                <ul class="yellow blogUl">
                    <?php $countSection=0; $totalEvent=count($allBlogs); for($i=0; $i<$totalEvent; ){ if($i % 6 == 0) {
                        if ($i==0) { 