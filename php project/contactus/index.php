...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    $to ="info@parentcompanyweb.org.np";
    switch(filter_input(INPUT_POST, "sendMsg")){
        case "contact":
            $name = filter_input(INPUT_POST, "name");
            $email = filter_input(INPUT_POST, "email");
            $msg = filter_input(INPUT_POST, "message");

            mail($to, "Enquiry by ".$name, $msg);
            header("location: ".$_SERVER["DOCUMENT_ROOT"]."/contactus/");
            break;
    }
}
?>
...
<head lang="en"><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <title>parent organization Nepal | Contact Us</title>
...
<div class="white">
<div class="center">
<div class="contactus"><p class="text6">Contact Us</p><br />
    <p class="text7">
       <pre> Parent organization nepal
        Visit us at  Kathmandu Nepal
        Reach us at parent@email.com</pre>
    </p>
    <div class="map">
