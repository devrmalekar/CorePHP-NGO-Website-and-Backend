...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $album= $dbFunction->Select("SP_EventPhotos", array("eventID"), array($eventID));
} else {
    header("location:".$_SERVER["DOCUMENT_ROOT"]."/Galeery");
}
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
<head>
    <title>parent organization Nepal | Gallery Photos</title>
    <meta charset="utf-8" />
...
<div class="white"><div class="center">
        <div class="row">
            ...
            <div class="galleryAlbum">
                <div class="yellow">
                    <?php $countSection=0; $totalEvent=count($album); for($i=0; $i<$totalEvent; ){ if($i % 16 == 0) {
                        ...
                        <div class="left memoryLeft">
                            <div class="galleryAlbum">
                                <div class="gallerythump">
                                    <div class="thumbnail">
                                        <a href=""><img class="thumbnailimg"  src="<?php if(isset($album[$i]["EventPhotoURL"]) && !empty($album[$i]["EventPhotoURL"])) {
