...
$result = $dbFunction->Select("SP_ListSlideShowImg",  array("eventType"), array("Parent") );

$isFormSubmit = filter_input(INPUT_POST, "save");
if(isset($isFormSubmit) && !empty($isFormSubmit)) {
    //$caption =filter_input(INPUT_POST, "");
    $target_path = "/cms/assets/images/SlideShowIMg/Parent/";
    $dir = "../.." . $target_path;
    $dbFunction->setEventType("Parent");
    $dbFunction->uploadImg($dir, $target_path, 5,"SP_NewSlideShowImg", array("imgUrl", "caption"));
...
<div class="container">
    ...
    <div class="row main-content">
            <form action="#" method="post" id="newEventGalleryForm" enctype="multipart/form-data" role="form" class="form-horizontal">
                <fieldset>
                    <legend><h2>Parent Slide Show Images</h2></legend>
