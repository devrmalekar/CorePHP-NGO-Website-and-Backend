...
$allEventData = $dbFunction->Select("SP_UpcomingEvent", array("eventType"), array("MFN"));
    ...
    <div class="main-content">
        <div class="col-xs-8">
            <div class="row page-header">
                <h1>Upcoming Activities List</h1>
            </div>
...
<script>
    $(document).ready(function (){
        ...
        $(".navbar-nav li").find("a[href='/Events/List/upcoming.php']").parents("li[class='dropdown']").addClass('active');
    })
    // init bootpag
