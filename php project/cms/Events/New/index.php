...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($return == 'success') {
        exit;
        $param_val = array($EventTitle, $EventDesc, $EventDate, $EventStartTime, $EventEndTime, $EventPlace, $EventType);

        $data = $dbFunction->Insert("SP_NewEvent", array("EventTitle", "EventDesc", "EventDate", "EventStartTime", "EventEndTime", "EventPlace", "EventType"),
            array($EventTitle, $EventDesc, $EventDate, $EventStartTime, $EventEndTime, $EventPlace, $EventType));
            ...
            <form action="#" method="post" novalidate="novalidate" id="newEventForm" enctype="application/x-www-form-urlencoded" role="form" class="form-horizontal">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="col-md-6">
                                <input type="radio" checked="true" required="true" class="radio radio-inline" value="NGO"  name="EventType" tabindex="1"> <label class="control-label">MFN</label></input>
                            </div>
                            <div class="col-md-6">
                                <input type="radio" class="radio radio-inline" value="ECH" name="EventType" tabindex="2" /> <label class="control-label">ECH</label>
                            </div>
                        </div>
                    </div>
