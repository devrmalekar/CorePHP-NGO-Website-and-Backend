...
<div class="white"><div class="center">
        <div class="whoarewe"><p class="text6">Who We Are</p><br />
            <p class="text7"><?php echo $aboutECH[0]["intro"]; ?>
            </p><br />

        </div>
        <div class="whoarewe"><p class="text6">Innaguaration Program</p><br />
            <p class="text7"><?php echo $aboutECH[0]["pro"]; ?>
            </p><br />
        </div>
        <div class="ourchildren" id="ourchildren">
            ...
            <p class="text7"><?php echo $aboutECH[0]["ourchildren"]; ?></p><br /><br />
        </div>
