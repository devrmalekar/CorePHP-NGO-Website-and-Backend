...
$RecentActivities = $dbFunction->Select("SP_RecentEvent", array("eventType"), array("ECH"));

$slideshow = $dbFunction->Select("SP_ListSlideShowImg", array("eventType"), array("ECH"));

$aboutMFN = $dbFunction->Select("SP_SelectAbout", array("id"), array(1));

$address = $aboutMFN[0]["PostalAddress"];
$phone = $aboutMFN[0]["TelePhone"];
$email =$aboutMFN[0]["Email"];

$aboutECH = $dbFunction->Select("SP_GetEchDetail", null, null);
 ...
 <div class="white">
     <div class="center  home-center">
         ...
         <div id="jssor_1">
            ...
            <div class="two">
                <iframe width="290" height="200" src="ttps://www.youtube.com/embed/">
                </iframe>
                <p class="text4">story 1</p>
            </div>
            <div class="three">
        ...
        <div class="content">
            <div class="who">
                ...
                <p class="text7"><?php echo substr($aboutECH[0]["intro"],0,350)."..."; ?>
                </p>
                <p><a  href="/ECH/aboutus/index.php" ><img src="/assets/images/03.png" alt="" /></a></p>
            </div>
            <div class="what"><p class="text6">Innaguaration</p><br /><p class="text6"> Program</p><br />
                <p class="text7"><?php echo substr($aboutECH[0]["pro"],0,250)."..."; ?>
                </p>
                <p><a  href="/ECH/aboutus/index.php#innprog" ><img src="/assets/images/03.png" alt="" /></a></p>
            </div>
            <div class="where">
                <p class="text6">Gallery</p><br />
                <p class="text7">Some Of The Moments Of ECH.</p>
                <p><img src="<?php echo $album[rand(0, count($album)-1)]['EventPhotoURL']; ?>" style="width: 299px; height: 158px;" alt="" /></p><br />
                <p class="text9"></p><br /><br />
                <p><a  href="/ECH/Gallery/index.php"><img src="/assets/images/03.png" alt="" /></a></p>
            </div>
            <div class="ourchildrens">
                <p class="text6">Our Children</p><br />
                <p><img src="<?php echo $album[rand(0, count($album)-1)]['EventPhotoURL']; ?>" style="width: 299px; height: 158px;" alt="" /></p><br />
                <p class="text7"><?php echo substr($aboutECH[0]["ourchildren"],0,150)."..."; ?></p><br /><br />
                <p><a  href="/ECH/aboutus/index.php#ourchildren"><img src="/assets/images/03.png" alt="" /></a></p>
            </div>
            <div class="echmam">
                <p class="text6">MRS. EVELYN KAVANAGH</p><br />
                <p><img src="/assets/images/ms.evelyn.jpg" style="width: 299px; height: 158px;" alt="Mrs. Evelyn Kavanagh " /></p><br />
                <p class="text7">An intelligent mind, beautiful soul and kind hearted lady, Mrs. Evelyn Kavanagh was born in 1923 in Malta, a very small Island in the Mediterranean Sea, as an eldest child in her family... </p><br /><br />
                <p><a  href="/ECH/aboutus/index.php#evelyn"><img src="/assets/images/03.png" alt="" /></a></p>
            </div>
        </div>
        <div class="clear"></div>
         <div class="linr"></div>
         ...
         <?php if(count($RecentActivities) > 0) { ?>
             <div id="recentActivities">
                 ...
                 <nav>
                     <ul class="yellow">
                         <?php $countSection=0; $totalEvent=count($RecentActivities); for($i=0; $i<4; ){ if($i>=count($RecentActivities)){ break; } if($i % 4 == 0) {
                             ...
                             <div class="left">
                                 <li>
                                     ...
                                     <div class="eventdetails">
                                         ...
                                         <form action="/ECH/activities/Details/" method="post"><input type="hidden" name="eventId" value="<?php echo $RecentActivities[$i]['id']; ?>" /><button type="submit"  style="background-image: url('/assets/images/03.png')"/> </form>
                                     </div>
                                 </li>
                             </div>
