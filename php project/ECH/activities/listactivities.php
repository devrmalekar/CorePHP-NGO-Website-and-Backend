...
<div class="row">
    ...
    <nav>
        <ul class="yellow">
            <?php $countSection=0; $totalEvent=count($allEventData); for($i=0; $i<$totalEvent; ){ if($i % 6 == 0) {
                ...
                <div class="left">
                    <li>
                        ...
                        <div class="eventdetails">
                            ...
                            <form action="/ECH/activities/Details/" method="post"><input type="hidden" name="eventId" value="<?php echo $allEventData[$i++]['id']; ?>" /><button type="submit"  style="background-image: url('/assets/images/03.png')"/> </form>
                        </div>
                    </li>
                </div>
